...
The [legacy .7z archive](../../.Old_Version/ModemController_V1.5.0.10.7z) contains the running Program and my Presets. You don't need to install anything. Just extract the .7z file and run the ModemController.exe file.
...
Screenshot 1 was referenced by the original README but is not present in this repository.
